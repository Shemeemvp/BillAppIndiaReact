...
function DemoClients() {
  function activeLink() {
    ...
    for (var i = 0; i < nav_links.length; i++) {
      ...
      if (nav_links[i].classList.contains("nav-demo-clients")) {
  ...
  function fetchClients() {
    axios
      .get(`${config.base_url}/get_demo_clients/`)
      .then((res) => {
        if (res.data.status) {
        ...
        <div className="content">
          ...
          <main style={{ background: "#fff" }}>
            <div className="container-fluid">
              <div className="Demo_clients py-4">
                <div className="row">
                  <div className="col-md-12">
                    <div
                      className="demo_clients px-3 py-3"
                      style={{ backgroundColor: "#eae9c4" }}
                    >
                      <h4 className="ms-2">Demo Clients</h4>
